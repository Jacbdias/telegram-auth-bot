...
INSERT INTO subscribers (name, email, phone, plan, status, origin) VALUES 
  ('Fatos da Bolsa Suporte', 'suportefatosdabolsa@telegram.user', '00000000000', 'Projeto Renda Passiva', 'active', 'manual')
...
INSERT INTO subscribers (name, email, phone, plan, status, origin) VALUES 
  ('Gabrine Acoes americanas', 'sem-email@telegram.user', '00000000000', 'CF VIP - FATOS DA BOLSA 1', 'active', 'manual')
ON CONFLICT (email) DO NOTHING;
...
-- Davi Souza
INSERT INTO subscribers (name, email, phone, plan, status, origin) VALUES 
  ('Davi Souza', 'davicnpi@telegram.user', '00000000000', 'Projeto Renda Passiva', 'active', 'manual')
ON CONFLICT (email) DO NOTHING;
...
-- Jacqueline Dias
INSERT INTO subscribers (name, email, phone, plan, status, origin) VALUES 
  ('Jacqueline Dias', 'Jacqueline_dias@telegram.user', '00000000000', 'Projeto Renda Passiva', 'active', 'manual')
ON CONFLICT (email) DO NOTHING;
...
-- Marcos Schilling
INSERT INTO subscribers (name, email, phone, plan, status, origin) VALUES 
  ('Marcos Schilling', 'Marcos_Schilling@telegram.user', '00000000000', 'CF VIP - FATOS DA BOLSA 1', 'active', 'manual')
ON CONFLICT (email) DO NOTHING;
