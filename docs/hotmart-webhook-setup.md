...
> Dica rápida: alguns produtos já têm fallback interno para os planos exatos cadastrados na tabela `channels`, como `5060609` → `Close Friends LITE`, `5060349` → `CF VIP - FATOS DA BOLSA 1`, `1650879`/`3670772` → `CF VIP - FATOS DA BOLSA 2` e `1128762`/`1762716`/`2163067`/`2947386` → `CF VIP - FATOS DA BOLSA 3`. Também estão mapeados `4218223` → `Projeto FIIS` e `5325106` → `Projeto Trump`. Mesmo assim, vale registrá-los no `HOTMART_PLAN_MAP` para manter tudo documentado no ambiente.
